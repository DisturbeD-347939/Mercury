                    ...
                    if(data[1]["result"][0][j]["id"] == data[0]["result"][0][i]["userID"])
                    {
                        ...
                        for(var k = 0; k < data[2]["result"].length; k++)
                        {
                            if(data[2]["result"][k][0] == data[1]["result"][0][j]["id"])
                            {
                                ...
                                {
                                    tempArray.push("<div class='post' id=" + data[0]["result"][0][i]["id"] + "><img class='profilePic' src='" + data[2]["result"][k][1] + "'</img><h2><div onclick=goToProfile(" + data[1]["result"][0][j]["id"] + ")>" + data[1]["result"][0][j]["first_name"] + " " + data[1]["result"][0][j]["surname"]  + "</div></h2><h3>" + data[0]["result"][0][i]["title"]+ "</h3><p class='content'>" + data[0]["result"][0][i]["content"] + "</p><p class='date'><small>" + date + "</small></p><img class='postPic'><div class='like' onclick=like(" + data[0]["result"][0][i]["id"] + ")><img class='postLike' src='../images/dislike.png'></img><p>0</p></div><div class='comments' onclick=showComments(" + data[0]["result"][0][i]["id"] + ")><img class='hiddenComments' src='../images/hiddenComments.png'></img><p>0</p></div><button onclick='deletePost(" + data[0]["result"][0][i]["id"] + ")'></button><div class='commentBox'></div></div>");
                                }
                                else
                                {
